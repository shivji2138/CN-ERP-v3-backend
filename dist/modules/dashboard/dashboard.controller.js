...
export const dashboardController = asyncHandler(async (req, res) => {
    ...
    const [employeeCount, departmentCount, activeProjects, pendingLeaves, internCount, taskByStatus] = await Promise.all([
    ...
    const data = { employeeCount, departmentCount, activeProjects, pendingLeaves, internCount, taskByStatus };
